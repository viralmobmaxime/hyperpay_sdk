...
SWIFT_CLASS("_TtC14ipworks3ds_sdk31AcsTransactionIDSupportBoldText")
@interface AcsTransactionIDSupportBoldText : NSObject
+ (void)greenLazyBindingInfoStart;
+ (void)withAlphaComponentCollectDeviceDataParams;
...
SWIFT_CLASS("_TtC14ipworks3ds_sdk22ExpectedBundleIDReturn")
@interface ExpectedBundleIDReturn : NSObject <MaskingCancelCReq>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)stubCodeLengthCstAuto:(NSData * _Null_unspecified)dataPacket;
- (void)newValueSetID:(NSData * _Null_unspecified)dataPacket;
- (void)curSymbolNameStrNotify:(int32_t)errorCode :(NSString * _Null_unspecified)description;
- (void)logLevelMySecuredUITextField:(int32_t)logLevel :(NSString * _Null_unspecified)message :(NSString * _Null_unspecified)logType;
- (void)titleEdgeInsetsStringObfuscator:(NSData * _Null_unspecified)certEncoded :(NSString * _Null_unspecified)certSubject :(NSString * _Null_unspecified)certIssuer :(NSString * _Null_unspecified)status :(int32_t * _Nonnull)accept;
- (void)normalizeStringBgColor:(NSString * _Null_unspecified)message;
@end
